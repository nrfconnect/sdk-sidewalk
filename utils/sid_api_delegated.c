...
#define X(api_function, ...) struct api_function##_args api_function##_ctx;
...
#define X(api_function, ...)                                                                       \
	...
	{                                                                                          \
		struct api_function##_args *arguments =                                            \
			CONTAINER_OF(work, struct api_function##_args, work);                      \
		arguments->return_value = api_function(                                            \
			WINDOW_ITERATOR_SIZE_2(WORKER_ARGUMENTS_TO_CALL, (, ), __VA_ARGS__));      \
...
#define X(api_function, ...)                                                                                                     \
	sid_error_t api_function##_delegated(                                                                                    \
		WINDOW_ITERATOR_SIZE_2(ARGUMENT_LIST, (, ), __VA_ARGS__))                                                        \
	{                                                                                                                        \
		if (!ctx.workq) {                                                                                                \
		...
		case 0:                                                                                                          \
			break;                                                                                                   \
		case 1:                                                                                                          \
			LOG_DBG("Function %s not submitted, but scheduled for queue",                                            \
				#api_function);                                                                                  \
			break;                                                                                                   \
		case 2:                                                                                                          \
			LOG_DBG("Function %s was already running, and has been scheduled for queue",                             \
				#api_function);                                                                                  \
			break;                                                                                                   \
		case -EBUSY:                                                                                                     \
			LOG_ERR("Function %s could not been submitted, queue is raining, or plugged or work item is cancelling", \
				#api_function);                                                                                  \
			break;                                                                                                   \
		case -EINVAL:                                                                                                    \
			LOG_ERR("Function %s could not been submitted, queue is NULL",                                           \
				#api_function);                                                                                  \
			break;                                                                                                   \
		case -ENODEV:                                                                                                    \
			LOG_ERR("Function %s could not been submitted, queue has not been started",                              \
				#api_function);                                                                                  \
			break;                                                                                                   \
		default:                                                                                                         \
			LOG_ERR("Could not submit function %s to queue due to unexpected error %d",                              \
				#api_function, ret);                                                                             \
		}                                                                                                                \
		...
		case 0:                                                                                                          \
			break;                                                                                                   \
		case -EBUSY:                                                                                                     \
			LOG_ERR("Could not take semaphore for %s. BUSY", #api_function);                                         \
			break;                                                                                                   \
		case -EAGAIN:                                                                                                    \
			LOG_ERR("Could not take semaphore for %s. Waiting period expired",                                       \
				#api_function);                                                                                  \
			break;                                                                                                   \
		}                                                                                                                \
...
#define X(api_function, ...)                                                                       \
	{                                                                                          \
		...
		case 0:                                                                            \
			break;                                                                     \
		case -EINVAL:                                                                      \
			LOG_ERR("Could not take semaphore for %s, invalid arguments",              \
				#api_function);                                                    \
			break;                                                                     \
		default:                                                                           \
			LOG_ERR("Could not take semaphore for %s, Unknown error %d",               \
				#api_function, ret);                                               \
		}                                                                                  \
