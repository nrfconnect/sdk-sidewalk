...
#define NUMBERS_OF_PINS                                                                            \
	(DT_NODE_HAS_STATUS(DT_NODELABEL(gpio0), okay) &&                                          \
			 DT_NODE_HAS_STATUS(DT_NODELABEL(gpio1), okay) ?                           \
		 (MAX_NUMBERS_OF_PINS - 1) :                                                       \
		 ((DT_NODE_HAS_STATUS(DT_NODELABEL(gpio0), okay) ?                                 \
			   (P0_PIN_NUM - 1) :                                                      \
			   (DT_NODE_HAS_STATUS(DT_NODELABEL(gpio1), okay) ? (P1_PIN_NUM - 1) :     \
									    0))))
