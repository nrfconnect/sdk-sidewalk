...
#define SID_INC16_ROLLOVER_PROTECT(value, inc)   ((value + inc) <= (UINT16_MAX) ? (value + inc) : (value))
#endif

#ifndef SID_INC8_ROLLOVER_PROTECT
#define SID_INC8_ROLLOVER_PROTECT(value, inc)   ((value + inc) <= (UINT8_MAX) ? (value + inc) : (value))
#endif

#ifndef SID_SET8_ROLLOVER_PROTECT
#define SID_SET8_ROLLOVER_PROTECT(old_val, new_val)   ((new_val) <= (UINT8_MAX) ? (new_val) : (old_val))
#endif

#ifndef SID_SET16_ROLLOVER_PROTECT
#define SID_SET16_ROLLOVER_PROTECT(old_val, new_val)   ((new_val) <= (UINT16_MAX) ? (new_val) : (old_val))
#endif

#ifndef SID_SET_INT8_ROLLOVER_PROTECT
#define SID_SET_INT8_ROLLOVER_PROTECT(old_val, new_val)   (((new_val >= (INT8_MIN)) && (new_val <= (INT8_MAX))) ? (new_val) : (old_val))
#endif

#ifndef SID_SET_INT16_ROLLOVER_PROTECT
#define SID_SET_INT16_ROLLOVER_PROTECT(old_val, new_val)   (((new_val >= (INT16_MIN)) && (new_val <= (INT16_MAX))) ? (new_val) : (old_val))
#endif
