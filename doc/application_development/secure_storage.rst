...
.. note::
   Once the identity keys have been moved from MFG storage partition to the trusted storage, you cannot read them back in plaintext and restore the MFG storage partition to its original state.
