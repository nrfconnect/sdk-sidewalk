...
|                                   | over Sidewalk network.                   | * `nRF5340 DK`_                           | * `Semtech SX1262MB2CAS`_ or LR1110MB1xxS (LoRa/FSK only)                 | * Application partition size = 956 kB         |                           |
|                                   |                                          | * `nRF54L15 DK`_                          |                                                                           |                                               |                           |
...
|                                   | having activated CLI.                    | * `nRF5340 DK`_                           | * `Semtech SX1262MB2CAS`_ or LR1110MB1xxS (LoRa/FSK only)                 | * Application partition size = 956 kB         |                           |
|                                   |                                          | * `nRF54L15 DK`_                          |                                                                           |                                               |                           |
|                                   |                                          | * nRF54L10 emulating on `nRF54L15 DK`_    |                                                                           |                                               |                           |
+-----------------------------------+------------------------------------------+-------------------------------------------+---------------------------------------------------------------------------+-----------------------------------------------+---------------------------+
