...
#define CHECK_SHELL_INITIALIZED(shell, cli_cfg)                                                    \
	if (cli_cfg.sidewalk_handle == NULL) {                                                     \
...
void initialize_sidewalk_shell(struct sid_config *sid_cfg, struct sid_handle **sidewalk_handle)
{
	cli_cfg.sidewalk_handle = sidewalk_handle;
...
static void sid_option_get(const struct shell *shell, enum sid_device_profile_id profile)
{
	...
	sid_error_t ret =
		sid_option_delegated(*cli_cfg.sidewalk_handle, SID_OPTION_900MHZ_GET_DEVICE_PROFILE,
...
int cmd_sid_init(const struct shell *shell, int32_t argc, const char **argv)
{
	...
	sid_error_t ret = sid_init_delegated(cli_cfg.sid_cfg, cli_cfg.sidewalk_handle);
...
int cmd_sid_deinit(const struct shell *shell, int32_t argc, const char **argv)
{
	...
	sid_error_t ret = sid_deinit_delegated(*cli_cfg.sidewalk_handle);
...
int cmd_sid_start(const struct shell *shell, int32_t argc, const char **argv)
{
	...
	sid_error_t ret = sid_start_delegated(*cli_cfg.sidewalk_handle, link_mask);
...
int cmd_sid_stop(const struct shell *shell, int32_t argc, const char **argv)
{
	...
	sid_error_t ret = sid_stop_delegated(*cli_cfg.sidewalk_handle, link_mask);
...
int cmd_sid_send(const struct shell *shell, int32_t argc, const char **argv)
{
	...
	sid_error_t ret = sid_put_msg_delegated(*cli_cfg.sidewalk_handle, &msg, &desc);
...
int cmd_sid_factory_reset(const struct shell *shell, int32_t argc, const char **argv)
{
	...
	sid_error_t ret = sid_set_factory_reset_delegated(*cli_cfg.sidewalk_handle);
...
int cmd_sid_get_mtu(const struct shell *shell, int32_t argc, const char **argv)
{
	...
	size_t mtu = 0;
	sid_error_t ret = sid_get_mtu_delegated(*cli_cfg.sidewalk_handle, link_type, &mtu);
...
int cmd_sid_option_battery(const struct shell *shell, int32_t argc, const char **argv)
{
	...
	sid_error_t ret = sid_option_delegated(*cli_cfg.sidewalk_handle,
...
int cmd_sid_option_lp_set(const struct shell *shell, int32_t argc, const char **argv)
{
	...
	sid_error_t ret =
		sid_option_delegated(*cli_cfg.sidewalk_handle, SID_OPTION_900MHZ_SET_DEVICE_PROFILE,
				     &dev_cfg, sizeof(dev_cfg));
...
int cmd_sid_last_status(const struct shell *shell, int32_t argc, const char **argv)
{
	...
	sid_error_t ret = sid_get_status_delegated(*cli_cfg.sidewalk_handle, &status);
...
int cmd_sid_conn_request(const struct shell *shell, int32_t argc, const char **argv)
{
	...
	sid_error_t ret =
		sid_ble_bcn_connection_request_delegated(*cli_cfg.sidewalk_handle, conn_req);
...
int cmd_sid_get_time(const struct shell *shell, int32_t argc, const char **argv)
{
	...
	sid_error_t ret = sid_get_time_delegated(*cli_cfg.sidewalk_handle, type, &curr_time);
...
int cmd_sid_set_dst_id(const struct shell *shell, int32_t argc, const char **argv)
{
	...
	sid_error_t ret = sid_set_msg_dest_id_delegated(*cli_cfg.sidewalk_handle, dst_id);
