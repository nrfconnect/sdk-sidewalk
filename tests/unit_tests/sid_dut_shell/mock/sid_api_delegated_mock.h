...
FAKE_VALUE_FUNC(sid_error_t, sid_put_msg_delegated, struct sid_handle *, const struct sid_msg *, struct sid_msg_desc *);
FAKE_VALUE_FUNC(sid_error_t, sid_set_factory_reset_delegated, struct sid_handle *);
FAKE_VALUE_FUNC(sid_error_t, sid_get_mtu_delegated, struct sid_handle *, enum sid_link_type, size_t *);
...
FAKE_VALUE_FUNC(sid_error_t, sid_get_time_delegated, struct sid_handle *, enum sid_time_format, struct sid_timespec *);
FAKE_VALUE_FUNC(sid_error_t, sid_set_msg_dest_id_delegated, struct sid_handle *, uint32_t);
FAKE_VALUE_FUNC(sid_error_t, sid_option_delegated, struct sid_handle *, enum sid_option, void *, size_t);
