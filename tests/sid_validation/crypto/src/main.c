...
static const uint8_t sha256_result[SHA256_SZ] = {
    0x16, 0xf6, 0x09, 0xe1, 0x5f, 0x33, 0x75, 0xe2,
...
static const uint8_t sha512_result[SHA512_SZ] = {
    0x08, 0x89, 0x42, 0x97, 0x01, 0x29, 0x4b, 0x44,
    0xa8, 0x02, 0xba, 0xf5, 0xff, 0x61, 0x58, 0xfb,
    0x35, 0xce, 0x42, 0xfd, 0x31, 0x14, 0x07, 0x97,
    0x5b, 0x56, 0x85, 0xe0, 0xe1, 0x25, 0x75, 0x3c,
    0xb2, 0x8c, 0xdd, 0x87, 0x66, 0x7e, 0xcb, 0x3a,
    0x10, 0x0b, 0xe9, 0xd5, 0x64, 0xfb, 0xa8, 0xed,
    0x2f, 0xd3, 0x21, 0x4f, 0xf9, 0xe0, 0xdc, 0xce,
...
static const uint8_t hmac_invalid_key[16] = {
    0x16, 0xf6, 0x09, 0xe1, 0x5f, 0x33, 0x75, 0xe2,
...
static const uint8_t hmac_sha256_result[SHA256_SZ] = {
    0xfd, 0x71, 0x58, 0xaa, 0x22, 0xe6, 0x34, 0x1d,
    0x19, 0x9a, 0x98, 0x04, 0x6f, 0x6e, 0x3e, 0x6f,
    0x3d, 0xc0, 0xdf, 0xdb, 0x1c, 0x51, 0xe9, 0x8a,
    0xcd, 0xf5, 0x97, 0xd6, 0x73, 0xf1, 0xea, 0x33
};

static const uint8_t hmac_sha512_result[SHA512_SZ] = {
    0x64, 0x84, 0xa8, 0x5b, 0x48, 0x62, 0x41, 0xa6,
    0xbf, 0x2e, 0xff, 0xe6, 0xed, 0x24, 0xf5, 0xd7,
    0x8b, 0x84, 0x10, 0xe8, 0x14, 0xaf, 0x3f, 0xed,
    0x4a, 0x6d, 0x98, 0xcc, 0x66, 0xc7, 0x4b, 0x48,
    0xe5, 0xaa, 0x7c, 0x14, 0x5f, 0x57, 0xea, 0xda,
    0x6b, 0xb2, 0xc7, 0x42, 0x98, 0xfe, 0x86, 0x7a,
    0xc9, 0xc8, 0xff, 0x2b, 0x3a, 0x31, 0xde, 0xec,
    0xc9, 0x6a, 0x81, 0xd4, 0xce, 0x0d, 0x5c, 0x5d
};
...
static const uint8_t aes_invalid_plaintext[16] = {
    0x6b, 0xc1, 0xbe, 0xe2, 0x2e, 0x40, 0x9f, 0x96,
...
uint8_t const aes_mac[16] = {
    0x07, 0x0a, 0x16, 0xb4, 0x6b, 0x4d, 0x41, 0x44,
    0xf7, 0x9b, 0xdd, 0x9d, 0xd0, 0x4a, 0x28, 0x7c
};
static const uint8_t aes_invalid_key[16] = {
    0x2b, 0x7e, 0x15, 0x16, 0x28, 0xae, 0xd2, 0xa6,
...
static const uint8_t aes_gcm_mac[] = {
    0xD6, 0xA5, 0x28, 0x4F, 0x4A, 0x6D, 0x3F, 0xE2,
    0x2A, 0x5D, 0x6C, 0x2B, 0x96, 0x04, 0x94, 0xC3
};

static const uint8_t aes_gcm_invalid_key[] = {
    0x07, 0x1B, 0x11, 0x3B, 0x0C, 0xA7, 0x43, 0xFE,
    0xCC, 0xCF, 0x3D, 0x05, 0x1F, 0x73, 0x73, 0xFF
};
static const uint8_t aes_gcm_invalid_aad[] = {
    0xE2, 0x01, 0x06, 0xD7, 0xCD, 0x0D, 0xF0, 0x76,
    0x1E, 0x8D, 0xCD, 0x3D, 0x88, 0xE5, 0x4C, 0x2A,
    0x76, 0xD4, 0x57, 0xFF
};
static const uint8_t aes_gcm_invalid_iv[] = {
    0xF0, 0x76, 0x1E, 0x8D, 0xCD, 0x3D, 0x00, 0x01,
    0x76, 0xD4, 0x57, 0xFF
};
...
static const uint8_t aes_gcm_invalid_mac[] = {
    0xD6, 0xA5, 0x28, 0x4F, 0x4A, 0x6D, 0x3F, 0xE2,
    0x2A, 0x5D, 0x6C, 0x2B, 0x96, 0x04, 0x94, 0xFF
};
_Static_assert(sizeof(aes_gcm_key) == sizeof(aes_gcm_invalid_key), "AES GCM key sizes are not equal");
_Static_assert(sizeof(aes_gcm_aad) == sizeof(aes_gcm_invalid_aad), "AES GCM AAD sizes are not equal");
_Static_assert(sizeof(aes_gcm_iv) == sizeof(aes_gcm_invalid_iv), "AES GCM IV sizes are not equal");
_Static_assert(sizeof(aes_gcm_ciphertext) == sizeof(aes_gcm_invalid_ciphertext), "AES GCM Ciphertext sizes are not equal");
_Static_assert(sizeof(aes_gcm_mac) == sizeof(aes_gcm_invalid_mac), "AES GCM key sizes are not equal");

//Test vector
//https://tools.ietf.org/html/rfc3686
static  const uint8_t aes_ctr_plaintext[32] = {
...
static const uint8_t aes_ctr_ciphertext[32] = {
    0x51, 0x04, 0xA1, 0x06, 0x16, 0x8A, 0x72, 0xD9,
    0x79, 0x0D, 0x41, 0xEE, 0x8E, 0xDA, 0xD3, 0x88,
    0xEB, 0x2E, 0x1E, 0xFC, 0x46, 0xDA, 0x57, 0xC8,
    0xFC, 0xE6, 0x30, 0xDF, 0x91, 0x41, 0xBE, 0x28
};
static const uint8_t aes_ctr_invalid_key[16] = {
    0x7E, 0x24, 0x06, 0x78, 0x17, 0xFA, 0xE0, 0xD7,
    0x43, 0xD6, 0xCE, 0x1F, 0x32, 0x53, 0x91, 0xFF
};
static const uint8_t aes_ctr_invalid_iv[16] = {
    0x00, 0x6C, 0xB6, 0xDB, 0xC0, 0x54, 0x3B, 0x59,
    0xDA, 0x48, 0xD9, 0x0B, 0x00, 0x00, 0x00, 0xFF
};
static const uint8_t aes_ctr_invalid_ciphertext[32] = {
    0x51, 0x04, 0xA1, 0x06, 0x16, 0x8A, 0x72, 0xD9,
    0x79, 0x0D, 0x41, 0xEE, 0x8E, 0xDA, 0xD3, 0x88,
    0xEB, 0x2E, 0x1E, 0xFC, 0x46, 0xDA, 0x57, 0xC8,
    0xFC, 0xE6, 0x30, 0xDF, 0x91, 0x41, 0xBE, 0xFF
};
_Static_assert(sizeof(aes_ctr_key) == sizeof(aes_ctr_invalid_key), "AES CTR key sizes are not equal");
_Static_assert(sizeof(aes_ctr_iv) == sizeof(aes_ctr_invalid_iv), "AES CTR IV sizes are not equal");
_Static_assert(sizeof(aes_ctr_ciphertext) == sizeof(aes_ctr_invalid_ciphertext), "AES CTR Ciphertext sizes are not equal");

//Generated from openssl
static const uint8_t curve25519_prk[32] = {
    0xB0, 0x76, 0x51, 0xEA, 0x20, 0xF0, 0x28, 0xA8,
    0x16, 0xEE, 0x01, 0xB0, 0xD1, 0x06, 0x2A, 0x7C,
    0x81, 0x58, 0xE8, 0x84, 0xE9, 0xBC, 0xC6, 0x1C,
    0x5D, 0xAB, 0xDB, 0x4E, 0x38, 0x2F, 0x96, 0x69,
};
static const uint8_t curve25519_puk[32] = {
    0x87, 0xD8, 0x6B, 0xDA, 0xAC, 0x38, 0x3C, 0x85,
    0xA6, 0xBC, 0xF8, 0xFC, 0xC6, 0x26, 0xD6, 0x14,
    0x36, 0xE4, 0x8F, 0xDB, 0xFA, 0x5A, 0x45, 0xFE,
    0x0C, 0x9E, 0xA8, 0x4B, 0x35, 0x3E, 0xF1, 0x37,
};
static const uint8_t curve25519_remote_prk[32] = {
    0x98, 0x2E, 0xB6, 0x7D, 0x0A, 0x01, 0x57, 0x90,
    0xE1, 0x45, 0xF3, 0x67, 0xF6, 0xDA, 0xA6, 0x44,
    0x2C, 0x87, 0xC0, 0xED, 0x3C, 0x36, 0x71, 0xA6,
    0x89, 0xC7, 0x49, 0xAC, 0x0D, 0xFE, 0x43, 0x6E,
};
static const uint8_t curve25519_remote_puk[32] = {
    0x0C, 0x04, 0x10, 0x5B, 0xE8, 0x7C, 0xAB, 0x37,
    0x21, 0x15, 0x7A, 0x8D, 0x49, 0x85, 0x8C, 0x7A,
    0x9F, 0xC1, 0x46, 0xDA, 0xCC, 0x96, 0xEF, 0x6E,
    0xD4, 0xDA, 0x71, 0xBF, 0xED, 0x32, 0x0D, 0x76,
};
static const uint8_t curve25519_shared_secret[32] = {
    0xF2, 0xE6, 0x0E, 0x1C, 0xB7, 0x64, 0xBC, 0x48,
    0xF2, 0x9D, 0xBB, 0x12, 0xFB, 0x12, 0x17, 0x31,
    0x32, 0x1D, 0x79, 0xAF, 0x0A, 0x9F, 0xAB, 0xAD,
    0x34, 0x05, 0xA2, 0x07, 0x39, 0x9C, 0x5F, 0x15,
};

//P256R1
static const uint8_t p256r1_prk[32] = {
    0xB7, 0xF6, 0x14, 0xC6, 0x31, 0x01, 0x65, 0x13,
    0x65, 0x9C, 0xF9, 0xD9, 0xC2, 0x2B, 0x69, 0x39,
    0x71, 0x4E, 0xC9, 0x6B, 0x08, 0x4F, 0x43, 0xDA,
    0x35, 0x88, 0xFD, 0x46, 0xA9, 0xF6, 0xDC, 0x7F,
};
static const uint8_t p256r1_puk[64] = {
    0xF8, 0x0D, 0xDB, 0x3D, 0xD0, 0x94, 0x42, 0xFE,
    0x53, 0x50, 0x3F, 0xE6, 0x9F, 0xE4, 0x0F, 0xFE,
    0x56, 0x74, 0x5C, 0x51, 0x20, 0x23, 0x55, 0x91,
    0x5F, 0x1B, 0xA3, 0x74, 0x2C, 0x39, 0xAE, 0x6F,
    0x25, 0x16, 0xED, 0xDE, 0x12, 0xDA, 0xD2, 0x3E,
    0x2E, 0x6E, 0xD1, 0x1E, 0x08, 0x9A, 0x6F, 0x1D,
    0x6A, 0x21, 0xCC, 0xCB, 0x90, 0x4D, 0x06, 0x36,
    0x25, 0xC8, 0xDA, 0xE5, 0x06, 0x34, 0xE9, 0xAF,
};
static const uint8_t p256r1_remote_prk[32] = {
    0xFE, 0x31, 0xF4, 0xA8, 0x01, 0xE2, 0xA9, 0x4B,
    0x71, 0xB7, 0xCA, 0xEC, 0x91, 0xD2, 0xC6, 0x3C,
    0x4D, 0x5B, 0x8A, 0x03, 0xB8, 0x17, 0xDB, 0x2C,
    0x8D, 0x6A, 0x3A, 0x90, 0xD0, 0x7A, 0x6D, 0xAF,
};
static const uint8_t p256r1_remote_puk[64] = {
    0xA9, 0xCD, 0xD3, 0x47, 0xA9, 0xFB, 0x3B, 0xC9,
    0xB8, 0x53, 0x8E, 0x04, 0x6F, 0xD5, 0xBF, 0x3B,
    0x3B, 0x72, 0xC2, 0x12, 0xE6, 0xFA, 0xE2, 0x4C,
    0x54, 0x54, 0x44, 0x92, 0x71, 0x2D, 0x52, 0x58,
    0xA8, 0x4A, 0x7D, 0xB0, 0xB4, 0x0A, 0x2F, 0x86,
    0x8C, 0x63, 0xBA, 0xFF, 0xA1, 0x15, 0xC9, 0x95,
    0x36, 0xDF, 0x69, 0xF9, 0x87, 0x29, 0x1E, 0x8E,
    0x09, 0x29, 0x4A, 0xA0, 0x3A, 0xFC, 0x4C, 0x27,
};
static const uint8_t p256r1_shared_secret[32] = {
    0x62, 0x4C, 0xFB, 0xA0, 0xDB, 0x79, 0x81, 0x1F,
    0x0F, 0x3F, 0x46, 0x82, 0xE6, 0x30, 0x57, 0xA7,
    0x0F, 0xA6, 0xD5, 0x25, 0x73, 0x87, 0x75, 0x3F,
    0x2D, 0xC8, 0xB3, 0x7A, 0x21, 0x16, 0x32, 0x9E,
};

//ed25519
static const uint8_t ed25519_prk[32] = {
    0xc6, 0x2a, 0x22, 0x9f, 0x15, 0x2a, 0x7f, 0x78,
    0x2e, 0xa0, 0x62, 0x8c, 0x53, 0x8e, 0xd2, 0x5b,
    0xe2, 0x7b, 0xa3, 0xc8, 0xcd, 0x07, 0x25, 0xe1,
    0x5c, 0x4a, 0x4a, 0xb8, 0x6e, 0x57, 0x8f, 0x54
};
static const uint8_t ed25519_puk[32] = {
    0x7e, 0x49, 0x3f, 0x82, 0xbe, 0x1d, 0x69, 0xc6,
...
static sid_error_t ecc_key_gen_positive(sid_pal_ecc_algo_t algo,
                                 uint8_t *const prk, size_t prk_sz,
...
static void ecc_ecdh_positive(sid_pal_ecc_algo_t algo, size_t prk_sz, size_t puk_sz)
{
    ...
    TEST_ASSERT_EQUAL(SID_ERROR_NONE, ret);
    TEST_ASSERT_EQUAL(0, memcmp(shared_secret, shared_secret_remote, params.shared_secret_sz));
    TEST_ASSERT_EQUAL(0, memcmp(get_ecc_shared_secret(algo), shared_secret, params.shared_secret_sz));
}
...
static void ecc_ecdh_negative(sid_pal_ecc_algo_t algo, size_t prk_sz, size_t puk_sz)
{
    ...
    ret = sid_pal_crypto_ecc_ecdh(&params);
    TEST_ASSERT_EQUAL(SID_ERROR_NONE, ret);
    TEST_ASSERT_NOT_EQUAL(0, memcmp(shared_secret, shared_secret_remote, params.shared_secret_sz));
}
